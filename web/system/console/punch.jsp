...
<div class="layui-fluid">
    ...
    <div id="consoleLink" class="layui-row layui-col-space15">
        <div class="layui-col-lg2 layui-col-md4 layui-col-sm4 layui-col-xs6">
            <div class="console-link-block" ew-href="system/leavesList.do" ew-title="请假审批">
                <div class="console-link-block-num">${fn:length(leaveList)}</div>
                <div class="console-link-block-text">请假审批</div>
                <c:choose>
                <c:when test="${leaveList!=null}">
                <div class="console-link-block-band">待审批</div>
                </c:when>
                    <c:otherwise>
                        <div class="console-link-block-band">无需要审批</div>
                    </c:otherwise>
                </c:choose>
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-row text-center">
                        <div class="layui-col-xs6">
                            <div id="tv1Num1" style="color: #28a6d6;font-size: 22px;"></div>
                            <div style="font-size: 18px;padding: 10px 0 15px 0;">未签到</div>
                        </div>
                        <div class="layui-col-xs6">
                            <div id="tv1Num2" style="color: #28a6d6;font-size: 22px;"></div>
...
<script>
    ...
    layui.use(['layer', 'table', 'admin'], function () {
        ...
        var res1 = {"msg":"操作成功","signNum":${fn:length(punches)},"signList":${punches},"code":200,"allNum":${count}};
        var mSignList = res1.signList;
        $("#tv1Num1").text(res1.allNum - res1.signNum);
        $("#tv1Num2").text(res1.signNum);
        myCharts1.setOption({
            title: {
